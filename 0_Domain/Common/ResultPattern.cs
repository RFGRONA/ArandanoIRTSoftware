...
public class Result
{
    ...
    protected Result(bool isSuccess, string errorMessage)
    {
        ...
        if (!isSuccess && string.IsNullOrEmpty(errorMessage))
            throw new InvalidOperationException("Un resultado fallido requiere un mensaje de error.");
...
public class Result<T> : Result
{
    ...
    /// Lanza una InvalidOperationException si se intenta acceder al valor de un resultado fallido.
    /// </summary>
    public T Value => IsSuccess ? _value! : throw new InvalidOperationException("No se puede acceder al valor de un resultado fallido. Verifique IsSuccess primero.");
