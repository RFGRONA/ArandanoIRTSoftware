...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Login(LoginDto model)
    {
        ...
        if (justLockedOut)
        {
            _logger.LogWarning("Cuenta de usuario {Email} bloqueada. Generando alerta con enlace de reseteo.",
                model.Email);
            ModelState.AddModelError("", "Esta cuenta ha sido bloqueada. Por favor, revise su correo electrónico.");
    ...
    public async Task<IActionResult> ForgotPassword(ForgotPasswordDto model)
    {
        ...
        // Por seguridad, siempre se muestra el mismo mensaje de confirmación,
        // exista o no la cuenta de correo, para evitar la enumeración de usuarios.
