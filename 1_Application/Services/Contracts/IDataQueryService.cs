...
/// <summary>
///     DTO que encapsula los parámetros comunes de filtrado y paginación para las consultas de datos.
/// </summary>
public class DataQueryFilters
{
...
public interface IDataQueryService
{
    ...
    /// <summary>
    ///     Extrae el valor de intensidad lumínica desde una cadena JSON de datos extra.
    /// </summary>
    /// <param name="extraDataJson">El JSON que contiene los datos extra.</param>
    /// <returns>El valor de la luz o null si no se encuentra.</returns>
    float? GetLightValueFromJson(string? extraDataJson);

    /// <summary>
    ///     Calcula el Déficit de Presión de Vapor (VPD) en kilopascales (kPa).
    /// </summary>
    /// <param name="temperature">La temperatura en grados Celsius.</param>
    /// <param name="humidity">La humedad relativa en porcentaje.</param>
    /// <returns>El valor del VPD en kPa.</returns>
