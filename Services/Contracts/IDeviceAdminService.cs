...
public interface IDeviceAdminService
{
    ...
    Task<IEnumerable<SelectListItem>> GetPlantsForSelectionAsync(); // Podría necesitar filtro por cultivo
    Task<IEnumerable<SelectListItem>> GetDeviceStatusesForSelectionAsync(); // Status para DeviceData
}